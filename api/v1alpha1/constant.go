...
func MakeComponentLabels(c *Pulsar, component string) map[string]string {
	return MakeAllLabels(c, component, "")
}

func MakeAllLabels(c *Pulsar, component string, childComponent string) map[string]string {
