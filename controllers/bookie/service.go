...
func MakeService(c *cachev1alpha1.PulsarCluster) *v1.Service {
	return &v1.Service{
		...
		ObjectMeta: metav1.ObjectMeta{
			...
			Labels:    cachev1alpha1.MakeComponentLabels(c, cachev1alpha1.BookieComponent),
		},
		Spec: v1.ServiceSpec{
			Ports:     makeServicePorts(c),
			ClusterIP: v1.ClusterIPNone,
			Selector:  cachev1alpha1.MakeComponentLabels(c, cachev1alpha1.BookieComponent),
		},
	}
}
...
func makeServicePorts(c *cachev1alpha1.PulsarCluster) []v1.ServicePort {
	return []v1.ServicePort{
		{
			Name: "server",
			Port: cachev1alpha1.PulsarBookieServerPort,
		},
	}
}
