...
func makeConfigMapReloadContainer(c *cachev1alpha1.PulsarCluster) v1.Container {
	return v1.Container{
...
func makeConfigMapReloadContainerArgs(c *cachev1alpha1.PulsarCluster) []string {
	return []string{
...
func makeConfigMapReloadContainerName(c *cachev1alpha1.PulsarCluster) string {
...
func makeContainerPort(c *cachev1alpha1.PulsarCluster) []v1.ContainerPort {
	return []v1.ContainerPort{
		{
			Name:          "prometheus",
			ContainerPort: cachev1alpha1.PulsarPrometheusServerPort,
			Protocol:      v1.ProtocolTCP,
		},
	}
}

func makeContainerVolumeMount(c *cachev1alpha1.PulsarCluster) []v1.VolumeMount {
