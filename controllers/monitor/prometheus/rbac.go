...
func MakeClusterRole(c *cachev1alpha1.PulsarCluster) *rbacv1.ClusterRole {
...
func MakeClusterRoleName(c *cachev1alpha1.PulsarCluster) string {
	return fmt.Sprintf("%s-prometheus-cluster-role", c.GetName())
}

func makeClusterRoleRules(c *cachev1alpha1.PulsarCluster) []rbacv1.PolicyRule {
...
func MakeServiceAccount(c *cachev1alpha1.PulsarCluster) *corev1.ServiceAccount {
...
func MakeServiceAccountName(c *cachev1alpha1.PulsarCluster) string {
	return fmt.Sprintf("%s-prometheus-serviceaccount", c.GetName())
}

func MakeClusterRoleBinding(c *cachev1alpha1.PulsarCluster) *rbacv1.ClusterRoleBinding {
...
func MakeClusterRoleBindingName(c *cachev1alpha1.PulsarCluster) string {
	return fmt.Sprintf("%s-prometheus-clusterrole-binding", c.GetName())
}

func makeSubjects(c *cachev1alpha1.PulsarCluster) []rbacv1.Subject {
