...
import (
	...
	"pulsar-operator/controllers/autorecovery"
...
func (r *PulsarClusterReconciler) reconcileAutoRecovery(c *cachev1alpha1.PulsarCluster) error {
...
func (r *PulsarClusterReconciler) reconcileBookieAutoRecoveryDeployment(c *cachev1alpha1.PulsarCluster) (err error) {
