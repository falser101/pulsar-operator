...
func (r *PulsarClusterReconciler) reconcileBookie(c *cachev1alpha1.PulsarCluster) error {
	if c.Status.Phase == cachev1alpha1.PulsarClusterInitializingPhase {
		return nil
	}
...
func (r *PulsarClusterReconciler) reconcileBookieConfigMap(c *cachev1alpha1.PulsarCluster) (err error) {
...
func (r *PulsarClusterReconciler) reconcileBookieStatefulSet(c *cachev1alpha1.PulsarCluster) (err error) {
...
func (r *PulsarClusterReconciler) reconcileBookieService(c *cachev1alpha1.PulsarCluster) (err error) {
...
func (r *PulsarClusterReconciler) isBookieRunning(c *cachev1alpha1.PulsarCluster) bool {
