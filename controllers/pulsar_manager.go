...
import (
	...
	"pulsar-operator/controllers/manager"
...
func (r *PulsarClusterReconciler) reconcileManagerConfigMap(c *cachev1alpha1.PulsarCluster) (err error) {
...
func (r *PulsarClusterReconciler) reconcileManagerStatefulSet(c *cachev1alpha1.PulsarCluster) (err error) {
...
func (r *PulsarClusterReconciler) reconcileManagerJob(c *cachev1alpha1.PulsarCluster) (err error) {
...
func (r *PulsarClusterReconciler) reconcileManagerService(c *cachev1alpha1.PulsarCluster) (err error) {
