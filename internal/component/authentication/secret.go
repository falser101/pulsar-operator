...
func MakeSecret(c *v1alpha1.PulsarCluster) *v1.Secret {
	return &v1.Secret{
...
func MakeBrokerSecret(c *v1alpha1.PulsarCluster) *v1.Secret {
	return &v1.Secret{
		ObjectMeta: metav1.ObjectMeta{
...
func MakeBrokerSecretName(c *v1alpha1.PulsarCluster) string {
	return fmt.Sprintf("%s-token-broker-admin", c.Name)
}

func MakeSecretName(c *v1alpha1.PulsarCluster) string {
	return fmt.Sprintf("%s-token-asymmetric-key", c.Name)
}

func GenerateAsymmetricKey(c *v1alpha1.PulsarCluster) (private []byte, public []byte, err error) {
...
func GenerateTokenKey(c *v1alpha1.PulsarCluster) (token []byte, err error) {
