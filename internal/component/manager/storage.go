...
func makeManagerTokensName(c *v1alpha1.PulsarCluster) string {
	return fmt.Sprintf("%s-manager-tokens", c.Name)
}

func makeManagerTokenKeysName(c *v1alpha1.PulsarCluster) string {
	return fmt.Sprintf("%s-manager-token-keys", c.Name)
}

func makeManagerBackendScriptName(c *v1alpha1.PulsarCluster) string {
	return fmt.Sprintf("%s-manager-backend-script", c.Name)
}

func makeManagerScriptName(c *v1alpha1.PulsarCluster) string {
	return fmt.Sprintf("%s-manager-script", c.Name)
}

func makeManagerDataName(c *v1alpha1.PulsarCluster) string {
...
func makeManagerAdminSecretName(c *v1alpha1.PulsarCluster) string {
	return fmt.Sprintf("%s-token-console-admin", c.Name)
}

func makeAsymmetricKeyName(c *v1alpha1.PulsarCluster) string {
...
func makeManagerDataVolumeClaimTemplate(c *v1alpha1.PulsarCluster) v1.PersistentVolumeClaim {
	return v1.PersistentVolumeClaim{
...
func makeManagerDataVolumeClaimSpec(c *v1alpha1.PulsarCluster) v1.PersistentVolumeClaimSpec {
